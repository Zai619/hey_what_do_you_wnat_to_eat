...
<head>
	...
	<script>
	  ...
	  function cal(){
		  ...
		  alert(pc);
		  if(pc >= 35){ 
			document.getElementById( "s").innerHTML = "你要再轉一份飲料嗎?";
...
<body>
		...
		<?php
			...
			print('<form method="get" action="#" id="網頁"><input style = "display:none;background-color:pink;" type="button" id="不要飲料" value="不要" /><input style = "display:none;background-color:pink;" type="button" id="要飲料" value="要" /><input type="submit" id="sure" value="下一步" style = "display: none; background-color: yellow;"/></form>');
		?>
